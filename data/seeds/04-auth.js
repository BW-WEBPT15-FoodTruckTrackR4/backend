...
exports.seed =  
  ...
  //   .then(function () {
      ...
      return knex('diners').insert([
        {username: 'foodiefan1', password: '$2a$09$fMUtRzYrLdRrDFHrRq7Ix.UkOcFxlkCENC0vprxMdYNOvp4jILiTy', currentLocation: 'Phoenix, AZ', favoriteTrucks: "Joe's Tacos, The Gorilla Cheese Truck, Taco Toppers"}, // ilovefood
